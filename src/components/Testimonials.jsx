      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mx-auto max-w-xl text-center">                    
          <h2 className="font-display text-4xl font-medium tracking-tighter text-gray-50 sm:text-5xl">
            Trusted by over                      
            <div className="text-yellow-400">+50,000 users</div>
          </h2>          
        </div>

        {/** Content */}
        <div className="mx-auto mt-16 flow-root max-w-2xl sm:mt-20 lg:mx-0 lg:max-w-none">
          <div className="-mt-8 sm:-mx-4 sm:text-[0] grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 flex">

            {/** Card */}
            {testimonials.map((testimonial, index) => (
              <div key={index} className="pt-8 sm:inline-block sm:w-full sm:px-4 h-full grow">
