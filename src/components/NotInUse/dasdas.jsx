...
export function CallToAction() {
 ...
 >
  ...
  <div className="flex flex-col ">
   <h2 className="font-display text-7xl font-medium text-gray-50 sm:text-7xl">
   TOP #1
   </h2>

   <span className="ml-2 mt-4 font-display text-3xl ">
   INDICADOR INSTITUCIONAL
   </span>

   <span className="ml-2 font-display text-3xl text-gray-50">
